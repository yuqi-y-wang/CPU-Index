...
from mysurvival import utils
from mysurvival.models import BaseModel
from mysurvival.models._survival_forest import _SurvivalForestModel
from mysurvival import PYTHON_VERSION
...
class BaseSurvivalForest(BaseModel):
    ...
    * splitrule: int (default=0)
    ...
    def __init__(self, splitrule = "Logrank", num_trees = 10, bins = 100):
    ...
    def fit(self, X, T, E, max_features = 'sqrt', max_depth = 5, 
        ...
        * save_memory:  bool (default=False) --
        ...
        self.times = np.linspace(min(T), max(T), self.bins)
...
class RandomSurvivalForestModel(BaseSurvivalForest):
    ...
    def __init__(self, num_trees = 10, bins = 100):
        super(RandomSurvivalForestModel, self).__init__("logrank", num_trees, bins)
...
class ExtraSurvivalTreesModel(BaseSurvivalForest):
    ...
    def __init__(self, num_trees = 10, bins = 100):
        super(ExtraSurvivalTreesModel, self).__init__("extratrees", num_trees, bins)
...
class ConditionalSurvivalForestModel(BaseSurvivalForest):
    ...
    def __init__(self, num_trees = 10, bins = 100):
        super(ConditionalSurvivalForestModel, self).__init__("maxstat", num_trees, bins)
